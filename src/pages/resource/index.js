				...
				const handleChange = (item,val) =>{
					...
					for ( var key in item ) {
						if( key  === 'template_type'){
							props.setTemplate(val)
						}
						if( key  === 'flavour'){
							console.log(key,val);
							props.setFlavour(val);
						} 
					}
				}
        return (
        ...
        <>
          ...
          <form>
						...
						<div className="grid grid-cols-2 gap-4">
								<RenderField  setFlavour={setFlavour} setTemplate={setTemplate} />
						</div>
					...
					<div className="block px-2 pb-0">
						...
						<form>
							...
							<div className="form-group flex grid md:grid-cols-3 gap-2 md:gap-4  items-center mb-6">
								...
								<input type="text" className="form-control block col-span-2 w-full px-3 py-1.5 text-base font-normal bg-white bg-clip-padding border border-solid border-gray-300 rounded" name="type" value={resType} disabled />
							</div>
							<div className="form-group flex grid md:grid-cols-3 gap-2 md:gap-4 items-center mb-6">
								<label className="block text-gray-700 text-sm font-bold md:mb-2" htmlFor="name">
										Flavour:
								...
								<input type="text" className="form-control block col-span-2 w-full px-3 py-1.5 text-base font-normal bg-white bg-clip-padding border border-solid border-gray-300 rounded"
										name="name" value={flavour} disabled />
							</div>
							<div className="form-group flex grid md:grid-cols-3 gap-2 md:gap-4  items-center mb-6">
								<label className="block text-gray-700 text-sm font-bold md:mb-2" htmlFor="name">
										Template Type:
								</label>
								<input type="text" className="form-control block col-span-2 w-full px-3 py-1.5 text-base font-normal bg-white bg-clip-padding border border-solid border-gray-300 rounded" name="type" value={template} disabled />
							</div>
